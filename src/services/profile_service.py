...
class ProfileService:
    ...
    async def load_profile(self) -> UserProfile | None:
        ...
        try:
            ...
            raise ValueError(f"Profile file is corrupted: {e}") from e
    ...
    async def save_profile(self, profile: UserProfile) -> None:
        ...
        try:
            ...
            if temp_path.exists():
                temp_path.unlink()
            raise ValueError(f"Failed to save profile: {e}") from e
    ...
    async def delete_profile(self) -> bool:
        ...
        try:
            ...
            raise ValueError(f"Failed to delete profile: {e}") from e
...
def create_profile_service(profile_path: str | None = None) -> ProfileService:
    """

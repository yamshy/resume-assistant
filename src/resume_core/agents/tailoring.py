...
class ResumeGenerationAgent:
    ...
    def _generate_resume(
        ...
        optimized_summary = self._optimize_summary(summary, analysis, emphasis)
        ...
        markdown = self._compose_markdown(profile, analysis, optimized_summary, matching)
        ...
        return TailoredResume(
            ...
            summary_of_changes="Updated summary to emphasize priority skills and leadership impact.",
    ...
    def _compose_markdown(
        ...
        lines = [f"# {profile.contact.name}", "", f"**{analysis.job_title}**", "", summary, ""]

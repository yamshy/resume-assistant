...
class TestTailorResumeEndpoint:
    ...
    async def test_tailor_resume_success(self, async_client: httpx.AsyncClient):
        ...
        _ = uuid4().hex  # Just to import uuid validation behavior
    ...
    async def test_tailor_resume_with_job_analysis_id(self, async_client: httpx.AsyncClient):
        ...
        request_payload = {
            ...
            "preferences": {"emphasis_areas": ["react", "typescript"], "excluded_sections": []},
        }
    ...
    @pytest.mark.asyncio
    async def test_tailor_resume_invalid_request_missing_job_description(
        ...
        request_payload = {"preferences": {"emphasis_areas": ["python"]}}
    ...
    @pytest.mark.asyncio
    async def test_tailor_resume_invalid_request_empty_job_description(
        self, async_client: httpx.AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_tailor_resume_invalid_request_malformed_json(
        self, async_client: httpx.AsyncClient
    ):
